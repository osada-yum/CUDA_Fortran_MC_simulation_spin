program clock_dual_lattice_yhalf_tableall_gpu_relaxation
  use, intrinsic :: iso_fortran_env
  use clock_dual_lattice_yhalf_tableall_gpu_m
  ...
  integer(int32), parameter :: tot_sample = 5000_int32
...
end program clock_dual_lattice_yhalf_tableall_gpu_relaxation
