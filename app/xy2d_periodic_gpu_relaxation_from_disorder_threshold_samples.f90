program xy2d_periodic_gpu_relaxation_from_disorder_threshold
  ...
  do i = 1, size(outs)
     ...
     write(outs(i), '(*(g0, 1x))' ) "# test initialize spins before each `set_random_samll_spin`"
  end do
...
end program xy2d_periodic_gpu_relaxation_from_disorder_threshold
