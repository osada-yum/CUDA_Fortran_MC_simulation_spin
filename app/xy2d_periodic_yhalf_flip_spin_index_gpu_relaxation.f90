program xy2d_periodic_yhalf_flip_spin_index_gpu_relaxation
  use, intrinsic :: iso_fortran_env
  use xy2d_periodic_yhalf_flip_spin_index_gpu_m
...
end program xy2d_periodic_yhalf_flip_spin_index_gpu_relaxation
