...
progfile="./app/xy2d_periodic_gpu_relaxation_from_disorder_finite_magne_samples.f90"
execname="xy2d_periodic_gpu_relaxation_from_disorder_finite_magne_samples"
